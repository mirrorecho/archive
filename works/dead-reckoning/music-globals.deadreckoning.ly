...
emptySectionOne  ={
  ...
  s1*4 \bar "||" 
  \time 6/8 s2.*5 \bar "||" 
  \time 4/4 s1*8 \break \bar "||" 
  \cadenzaOn 
    <> \tempo \markup \fontsize #1.6 { \rounded-box \bold "everyone freely until A (approx 20'')" }
...
emptySectionTwo = {
  ...
  %\time 4/4 s1  \bar "||" 
  %\tempo "Rit."
  \time 6/8 s2.*9 \break \bar "||" 
  <> \tempo \markup \fontsize #1.6 { \rounded-box \bold "everyone freely until B (approx 20 ''" }
  \cadenzaOn s1*6 
...
emptySectionThree = {
  ...
  s2.*4 \bar "||"
  \time 4/4
  s1*10 \break \bar "||" % 24 measures of 4/4
  <> \tempo \markup \fontsize #1.6 { \rounded-box \bold "everyone freely, slowing down" }
  \cadenzaOn s1*7
